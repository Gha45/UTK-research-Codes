    ...
    for root, _, files in os.walk(input_folder):
        for file_name in files:
            if file_name.endswith('.peaks'):
                ...
                amorph_frac = Amorph / Total if Total else 0
                ...
                # Error propagation using Amorphous/(Amorphous + crystalline)
                term1 = ((crystalline/(Total**2))**2)*(gaussian_df['Param_1_Error'].pow(2).sum())
                term2 = ((Amorph/(Total**2))**2)*(pseudovoigt_df['Param_1_Error'].pow(2).sum())
                amorph_error = math.sqrt( term1 + term2)
...
#output_folder = '/Users/georgeadamson/Desktop/Amorphous Fraction anaylsis/Amorphrac3 Python Script output/Ho2Ti2O7_Output2'
file_path = '/Users/georgeadamson/Desktop/Amorphous Fraction anaylsis/Fityk fitting/Complete He_Pyrochlore'
output_folder = '/Users/georgeadamson/Desktop/Amorphous Fraction anaylsis/Amorphrac3 Python Script output/HE_pyrochlore_file_output'
